...
public class DialogDataBase {
    ...
    /**
     * Objet Properties permettant de charger le fichier de configuration de la base de données.
     */
    private Properties properties = new Properties();

    /**
     * Constructeur privé de la classe DialogDataBase.
     * @param beloteDir : répertoire de stockage des données de l'application.
     * @param createFile : chemin du script SQL de création des tables de la base de données de l'application.
     * @param databaseConfigFile : chemin du fichier de configuration de la base de données.
     * @throws SQLException : en cas d'erreur lors de la connexion à la base de données.
     * @throws FileNotFoundException si le fichier de création des tables n'est pas trouvé.
     */
