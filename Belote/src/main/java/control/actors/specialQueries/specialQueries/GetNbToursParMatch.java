...
public class GetNbToursParMatch extends SpecialQuery {
    ...
    /**
     * Constructeur prenant en paramètre une liste de chaînes de caractères qui contient l'identifiant du tournoi.
     * La méthode récupère le nombre de tours de chaque match d'un tournoi spécifique ainsi que le nombre de matchs joués
     * et terminés pour chaque tour. La requête SQL est stockée dans la variable strSQL.
     * @param parametres une liste de chaînes de caractères qui contient l'identifiant du tournoi.
     */
