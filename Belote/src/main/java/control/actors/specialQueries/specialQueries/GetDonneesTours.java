 ...
 * pour chaque équipe dans un tournoi spécifique.
...
public class GetDonneesTours extends SpecialQuery {
     ...
     * correspondante.
     * La requête récupère toutes les équipes et le nombre de matchs gagnés par
     * chaque équipe dans le tournoi
     * spécifié par le premier paramètre.
     * La requête est triée par nombre de matchs gagnés décroissant.
     *
