/**
 * La classe GetNbMatchsParEquipes est une requête spéciale qui permet d'obtenir le nombre de matchs disputés
 * entre deux équipes spécifiées.
...
public class GetNbMatchsParEquipes extends SpecialQuery {
     ...
     * correspondante.
     * La requête récupère le nombre de matchs disputés entre deux équipes
     * spécifiées par les deux premiers paramètres.
     *
