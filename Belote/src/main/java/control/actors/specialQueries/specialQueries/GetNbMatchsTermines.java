 ...
 * dans un tournoi spécifié, ainsi que le nombre de matchs terminés.
...
public class GetNbMatchsTermines extends SpecialQuery {
     ...
     * correspondante.
     * La requête récupère le nombre total de matchs disputés dans un tournoi
     * spécifié par le premier paramètre,
     * ainsi que le nombre de matchs terminés.
     *
