...
public class GetResultatsMatch extends SpecialQuery {
    /**
     * Constructeur de la classe GetResultatsMatch qui prend en paramètre une liste
     * de chaînes de caractères
     * représentant les paramètres nécessaires pour exécuter la requête SQL. Les
     * résultats de la requête
     * sont stockés dans la variable strSQL de la superclasse SpecialQuery.
     * 
     * @param parametres la liste de paramètres nécessaires pour exécuter la requête
     *                   SQL
     */
