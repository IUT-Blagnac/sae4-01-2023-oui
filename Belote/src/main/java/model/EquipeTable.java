...
public class EquipeTable extends AbstractTableModel {
    ...
    /**
     * Cette méthode retourne la valeur située à la ligne arg0 et à la colonne arg1
     * du tableau.
     *
    ...
    /**
     * Cette méthode retourne vrai si la cellule située à la position x et y est
     * éditable,
     * faux sinon.
     *
    ...
    /**
     * 
     * Met à jour la valeur de la cellule située à l'intersection de la ligne
     * spécifiée par rowIndex et de la colonne spécifiée par columnIndex
     * avec la valeur spécifiée aValue.
     * 
     * @param aValue      la nouvelle valeur pour la cellule
     * @param rowIndex    l'index de la ligne où se trouve la cellule à mettre à
     *                    jour
     * @param columnIndex l'index de la colonne où se trouve la cellule à mettre à
     *                    jour
     */
