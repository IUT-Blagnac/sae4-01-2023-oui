...
[.text-justify]
L'analyse du code source existant de l'application est retrouvable https://github.com/IUT-Blagnac/sae4-01-2023-oui/Documentation/Analyse_application.adoc[ici].
